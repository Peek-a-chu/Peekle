...
ALTER TABLE study_problems ADD COLUMN IF NOT EXISTS custom_title VARCHAR(255);
ALTER TABLE study_problems ADD COLUMN IF NOT EXISTS custom_link VARCHAR(255);
