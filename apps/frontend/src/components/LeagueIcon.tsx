...
export type LeagueType = 'stone' | 'bronze' | 'silver' | 'gold' | 'platinum' | 'emerald' | 'diamond' | 'ruby';

// 리그 순서 (낮은 순위 → 높은 순위)
export const LEAGUE_ORDER: LeagueType[] = ['stone', 'bronze', 'silver', 'gold', 'platinum', 'emerald', 'diamond', 'ruby'];
