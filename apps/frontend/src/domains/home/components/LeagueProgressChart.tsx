...
import { LEAGUE_NAMES, LEAGUE_ORDER, LEAGUE_COLORS, LeagueType } from '@/components/LeagueIcon';
            ...
            <div className="flex">
                ...
                <div className="flex flex-col justify-between h-[200px] pr-2">
                    {yAxisIcons.map((league) => (
                        <div key={league} className="flex items-center justify-center" style={{ height: `${100 / yAxisIcons.length}%` }}>
                            <Image
