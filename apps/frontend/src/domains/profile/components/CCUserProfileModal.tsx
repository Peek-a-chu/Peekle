            ...
            <div className="flex flex-col items-center gap-3">
              <div className="relative">
                ...
                <div className="h-24 w-24 rounded-full overflow-hidden border-4 border-background shadow-lg bg-muted flex items-center justify-center">
                   {profile.profileImg ? (
                     <img src={profile.profileImg} alt={profile.nickname} className="w-full h-full object-cover" />
                   ) : (
                     <span className="text-2xl font-bold text-muted-foreground">{profile.nickname.substring(0, 1)}</span>
                   )}
                </div>
              </div>
