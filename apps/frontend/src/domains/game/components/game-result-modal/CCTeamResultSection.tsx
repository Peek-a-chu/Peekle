        ...
        <div className="w-full h-full flex items-stretch gap-8 p-2">
            ...
            <div className="w-48 flex flex-col items-center justify-center shrink-0 relative z-20">
                ...
                <div className="relative animate-bounce-slow">
                    {winningTeam !== 'DRAW' ? (
                        <>
                            ...
                            />
                            <div className={`absolute -top-4 left-1/2 -translate-x-1/2 whitespace-nowrap text-xs font-black px-2 py-0.5 rounded-full border bg-background ${winningTeam === 'RED' ? 'text-red-500 border-red-500' : 'text-blue-500 border-blue-500'}`}>
                                WINNER
                            </div>
                        </>
                    ) : (
                ...
                <div className="mt-4 flex flex-col items-center gap-1">
                    <span className="text-muted-foreground text-[10px] font-bold tracking-[0.2em] uppercase">Victory</span>
                    <h2 className={`text-3xl font-black italic tracking-tighter uppercase ${winningTeam === 'RED' ? 'text-red-500 drop-shadow-[0_0_15px_rgba(239,68,68,0.5)]' :
                        winningTeam === 'BLUE' ? 'text-blue-500 drop-shadow-[0_0_15px_rgba(59,130,246,0.5)]' :
                            'text-gray-400'
                        }`}>
                        {winningTeam}
                    </h2>
                ...
                <div className="mt-2 relative">
                    ...
                    <span className="relative z-10 text-lg font-black text-muted-foreground/50 italic">VS</span>
                </div>
            </div>
