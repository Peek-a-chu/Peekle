    ...
    return (
        <div className="flex flex-col items-center justify-center px-4 pb-0 pt-1">
            <div className="relative mb-4 group saturate-200 animate-twinkle">
                ...
                />
                <LeagueIcon league={league} size={100} className="relative z-10 drop-shadow-2xl transform transition-transform group-hover:scale-110 duration-300" />
            </div>

            <div className="text-center">
                <h3 className="text-2xl font-black text-foreground tracking-tight uppercase" style={{ color: leagueColor }}>
                    {LEAGUE_NAMES[league]}
                </h3>
